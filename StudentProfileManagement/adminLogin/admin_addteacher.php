...
<body style="background-color:#f8c291">
	...
	<div id="admin-button-wrapper">
		<form class="ad_btns" action="admin_addteacher.php" method="post">
			...
			<a href="admin_addcourse.php"><input type="button" id="add_course" value="Add Course"/></a>
			<a href="admin_addstudent.php"<input type="button" id="add_student" value="Add Student"/></a>
