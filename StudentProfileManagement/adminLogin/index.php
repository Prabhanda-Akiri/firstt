...
<body style="background-color:#f8c291">
	...
	<div id="choice-wrapper">
		<form class="choice_btns" action="index.php" method="post">
			<a href="adminlogin.php"><input type="button" id="admin" value="Admin"/></a>
			<input type="button" id="teacher" value="Teacher"/>
			<a href="parentlogin.php"><input type="button" id="parent" value="Parent"/></a>
		</form>
	</div>	
