...
<body style="background-color:#f8c291">
	...
	<div id="admin-button-wrapper">
		<form class="ad_btns" action="parent_sf.php" method="post">
	...
	<div id="add_t" style="text-align:left;">
					<center><label style="color:#586ebc;font-size:24px;"><br><br><b><u>Student Feedback</b></u></label><br></center>
			<form method="post">
			<br><br><label style="font-size:18px;margin-left:180px;">Student Name:</label>
				<input name="studname" type="text" class="inputdetails" style="margin-left:110px;" required /><br>
		
				<label style="font-size:18px;margin-left:50px;"><br><br><b><u>Enter the feedback below:-</u></b></label><br>
				<label><label><br>
				<textarea name="feedback" cols="100" rows="10" placeholder="Give Feedback about your child to Admin here..."  required></textarea><br><br>
				...
				<?php
					...
					if(isset($_POST['submit_bt']))
					{
						...
						$query = "INSERT INTO student_feedback VALUES('".$username."','".$studname."','".$feedback."')";
