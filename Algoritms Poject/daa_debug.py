...
def main():
    ...
    cities=["Manhattan","Mangalore","Bangalore"]
    ...
    if log_choice==2:
        ...
        if passwords[uid]==u_pass :
            ...
            s=input()
            print('\n\n2.   We are assuming that you have low fuel which is just enough to travel along the ')
            print('length and breadth of the city. We guide you the path from starting stop in the city to ')
            print('the last stop without violating the fuel citeria..!!')
